...
export default function Welcome({ about }: { about?: boolean }) {
	...
	return (
		<div className="md:w-10/12 mx-auto mt-32">
			...
			<div
				className={clsx(
					"flex flex-row justify-center items-center gap-6 mt-5 flex-wrap md:flex-nowrap",
			...
			>
				{gallery.map(({ src, alt, width, height }, index) => (
					<Image
						...
						alt={alt}
						className={clsx(
							"w-full h-auto transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg",
