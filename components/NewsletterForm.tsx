    ...
    <>
      ...
      >
        <input
          ...
          className="p-5 bg-transparent border opacity-35 placeholder:opacity-80  focus:opacity-100 border-black-75 -mr-1.5 rounded-lg transition-all -z-5 focus:outline-hidden"
          value={email}
